...
{
    sortArray(valores,9);
    makeEqual(proEqual,9);
    double average=avg(valores,9);
    printf("%f\n",average);
    double deviationStandard=deviation(valores,average,9);
    printf("%f\n",deviationStandard);
    typing(type,valores,average,deviationStandard,9);
    makePhi(phiZ,type,9);
    makeDiffPhi(diff,proEqual,phiZ,9);
    makeLastDiff(diff2,phiZ,proEqual,9);
    printf("Values\n");
    printArray(valores,9);
    printf("ProEqual\n");
    printArray(proEqual,9);
    printf("Typing\n");
    printArray(type,9);
    printf("PhiZ\n");
    printArray(phiZ,9);
